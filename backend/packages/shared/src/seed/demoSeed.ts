...
export const phase0DemoSeed: DemoSeedData = {
  ...
  studentProfiles: [
    ...
    },
    {
      ...
      shortBio: "Already joined a lunch activity for the leave-flow demo."
    },
    {
  ...
  activities: [
    {
      ...
      title: "Library Lunch Table",
      categoryId: demoCategoryLunchOptionId,
      categoryLabel: "Lunch",
      description: "Casual lunch near the library for students who want company between classes.",
      startsInHours: 1,
      durationHours: 1,
    ...
    },
    {
      ...
      title: "Espresso Break Before Lab",
      categoryId: demoCategoryCoffeeOptionId,
      categoryLabel: "Coffee",
      description: "Quick coffee stop before afternoon lab work, open to anyone nearby.",
      startsInHours: 3,
      durationHours: 1,
      meetingPointId: demoCafeteriaLocationOptionId,
      meetingPointLabel: "Cafeteria",
