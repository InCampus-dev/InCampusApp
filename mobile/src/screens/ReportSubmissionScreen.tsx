...
const styles = StyleSheet.create({
  ...
  targetIcon: { width: 42, height: 42, borderRadius: 12, backgroundColor: colors.primarySoft, borderWidth: 1, borderColor: colors.successSoft, alignItems: 'center', justifyContent: 'center' },
  targetIconText: { color: colors.primary, fontSize: 16, fontWeight: '900' },
